...
from codehealthanalyzer.version import __version__
...
man_pages = [
    ("index", "codehealthanalyzer", "CodeHealthAnalyzer Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "CodeHealthAnalyzer",
        "Biblioteca Python para análise de qualidade de código.",
        "Miscellaneous",
    ),
]
